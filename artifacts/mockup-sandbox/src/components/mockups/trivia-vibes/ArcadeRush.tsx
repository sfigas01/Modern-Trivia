      ...
      <div className="w-full max-w-md space-y-6 pb-12">
        ...
        <header className="text-center space-y-3 pt-6 pb-2">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded bg-[#0f1a13] border border-[#00ff88]/30 mb-2 shadow-[0_0_10px_rgba(0,255,136,0.1)]">
            ...
            <span className="text-[#00ff88] text-xs font-['Roboto_Mono'] uppercase tracking-[0.2em] font-bold">
              Not Started
            </span>
          </div>

          <h1
            className="text-5xl sm:text-6xl font-black font-['Outfit'] tracking-tighter text-white uppercase"
            style={{
              textShadow:
                '0 0 10px rgba(0,255,136,0.5), 0 0 20px rgba(0,255,136,0.3), 0 0 40px rgba(0,255,136,0.1)',
            }}
          >
            TRIVIA CLASH
          </h1>
        ...
        <section className="bg-[#0f1a13] border-2 border-[#00ff88]/50 rounded-md p-5 shadow-[0_0_15px_rgba(0,255,136,0.15)] relative overflow-hidden group">
          ...
          <div className="space-y-2">
            {teams.map((team, idx) => (
              ...
              >
                <span
                  className={`font-['Space_Grotesk'] font-bold text-sm tracking-wide ${idx === 0 ? 'text-white' : 'text-gray-300'}`}
                >
                  {team}
                </span>
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-['Roboto_Mono'] ${isSelected ? 'text-[#080c0a]/70 font-black' : 'text-[#00ff88]/40'}`}
                  >
                    [{cat.count}]
                  </span>
                </button>
        ...
        <div className="bg-[#ffaa00]/10 border-2 border-[#ffaa00] rounded-md p-4 flex items-start gap-3 shadow-[0_0_15px_rgba(255,170,0,0.15)]">
          ...
          <div>
            <h3 className="text-[#ffaa00] font-['Roboto_Mono'] text-sm font-bold uppercase mb-1">
              Low Question Count
            </h3>
            <p className="text-[#ffaa00]/80 text-xs font-['Space_Grotesk'] leading-relaxed">
              Not enough questions in the selected category for the requested number of rounds. Some
        ...
        <div className="pt-2">
          <button className="w-full relative group block">
            ...
            <div className="relative bg-[#00ff88] group-hover:bg-[#33ff99] group-active:scale-[0.98] text-[#080c0a] border-2 border-[#ffffff]/40 rounded-md py-6 px-6 flex items-center justify-center gap-4 transition-all overflow-hidden shadow-[inset_0_0_20px_rgba(255,255,255,0.3)]">
              ...
              <span className="font-['Outfit'] font-black text-3xl tracking-[0.15em] relative z-10">
                START GAME
              </span>
            </div>
          </button>
        ...
        <footer className="flex justify-center items-center gap-6 text-xs font-['Roboto_Mono'] tracking-[0.2em] text-[#00ff88]/50 pt-4">
          <a
            href="#"
            className="hover:text-[#00f0ff] hover:shadow-[#00f0ff] transition-colors uppercase"
          >
            Sign In
          </a>
          <span className="opacity-30">|</span>
          <a href="#" className="hover:text-[#ff0055] transition-colors uppercase">
            Admin Panel
          </a>
        </footer>
      </div>

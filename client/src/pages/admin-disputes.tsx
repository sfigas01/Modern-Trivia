...
import { AlertCircle, CheckCircle, XCircle, BrainCircuit } from "lucide-react";
                        ...
                        disputes?.map((dispute) => (
                            <Card key={dispute.id} className="bg-white/5 border-white/10 overflow-hidden">
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    {/* Right: Actions / AI */}
                                    <div className="p-6 w-full md:w-80 bg-muted/5 space-y-4 flex flex-col">
                                        <div className="flex-1">
                                            ...
                                            {dispute.aiAnalysis ? (
                                                <div className="text-sm text-muted-foreground p-3 bg-white/5 rounded">
                                        ...
                                        <div className="space-y-2 pt-4 border-t border-white/10">
                                            <Button
                                                ...
                                                disabled={analyzingId === dispute.id}
                                            >
                                                {analyzingId === dispute.id ? "Analyzing..." : "Analyze Dispute"}
                                            </Button>
                                            <div className="grid grid-cols-2 gap-2">
                                                <Button variant="outline" className="border-green-500/20 hover:bg-green-500/10 hover:text-green-500">
                                                    <CheckCircle className="w-4 h-4 mr-2" /> Accept
                                                </Button>
                                                <Button variant="outline" className="border-red-500/20 hover:bg-red-500/10 hover:text-red-500">
